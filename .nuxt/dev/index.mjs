...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///project/workspace/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///project/workspace/node_modules/devalue/index.js';
import { renderToString } from 'file:///project/workspace/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///project/workspace/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///project/workspace/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///project/workspace/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///project/workspace/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///project/workspace/node_modules/hookable/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///project/workspace/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///project/workspace/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///project/workspace/node_modules/defu/dist/defu.mjs';
import { hash as hash$1 } from 'file:///project/workspace/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///project/workspace/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///project/workspace/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///project/workspace/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///project/workspace/node_modules/radix3/dist/index.mjs';
import { FontStyle, BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///project/workspace/node_modules/shiki-es/dist/shiki.node.mjs';
import { consola } from 'file:///project/workspace/node_modules/unenv/runtime/npm/consola.mjs';
import { extname } from 'file:///project/workspace/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///project/workspace/node_modules/unified/index.js';
import { toString } from 'file:///project/workspace/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///project/workspace/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///project/workspace/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///project/workspace/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///project/workspace/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///project/workspace/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///project/workspace/node_modules/micromark-util-sanitize-uri/dev/index.js';
import slugify from 'file:///project/workspace/node_modules/slugify/slugify.js';
import remarkParse from 'file:///project/workspace/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///project/workspace/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///project/workspace/node_modules/remark-mdc/dist/index.mjs';
import { toString as toString$1 } from 'file:///project/workspace/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///project/workspace/node_modules/github-slugger/index.js';
import { detab } from 'file:///project/workspace/node_modules/detab/index.js';
import remarkEmoji from 'file:///project/workspace/node_modules/remark-emoji/index.js';
import remarkGFM from 'file:///project/workspace/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///project/workspace/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///project/workspace/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///project/workspace/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///project/workspace/node_modules/rehype-raw/index.js';
import { remarkPlugins, rehypePlugins, highlight } from 'file:///project/workspace/.nuxt/mdc-imports.mjs';
import { visit } from 'file:///project/workspace/node_modules/unist-util-visit/index.js';
import { Text, version, unref } from 'file:///project/workspace/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///project/workspace/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///project/workspace/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/project/workspace/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/project/workspace/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/project/workspace/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/project/workspace","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/project/workspace/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/project/workspace/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/project/workspace/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/project/workspace/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _NgorRQhIcd = (function(nitro) {
...
const _p5oFD8 = eventHandler(async (event) => {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///project/workspace/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _D81T8b = defineEventHandler(async (event) => {
...
const _g8wJf6 = defineEventHandler(async (event) => {
...
const _zzYoK9 = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_zJjhbE = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_zJjhbE, lazy: true, middleware: false, method: undefined },
  { route: '/api/_mdc/highlight', handler: _p5oFD8, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _D81T8b, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _D81T8b, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _D81T8b, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _g8wJf6, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _zzYoK9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _zzYoK9, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _zzYoK9, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_zJjhbE, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":"anonymous"},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,400;0,700;1,400;1,700&display=swap"}],"style":[],"script":[{"src":"https://code.jquery.com/jquery-3.7.1.slim.min.js","integrity":"sha256-kmHvs0B+OpCW5GVHUNjv9rOmY0IvSIRcf7zGUDTDQM8=","crossorigin":"anonymous"}],"noscript":[]};
...
const getClientManifest = () => import('file:///project/workspace/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///project/workspace/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
